         ...
         <section class="row">
             ...
             <div class="col-md-3">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtSearchCompanyId" runat="server" CssClass="form-control" AutoCompleteType="Disabled" CausesValidation="true" ValidationGroup="SearchInput"></asp:TextBox>
                     <asp:RequiredFieldValidator ID="rfvSearchCompanyId" runat="server" ControlToValidate="txtSearchCompanyId" ErrorMessage="Field required!" CssClass="text-danger" ValidationGroup="SearchInput"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group">
